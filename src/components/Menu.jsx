...
function Menu({ onLoginClick, onRegisterClick }) {
  ...
  const MenuIngresar = [
    { name: 'Inicia Sesión', path: '/inicia-sesion', action: onLoginClick },
    { name: 'Registrarme', path: '/registrarme', action: onRegisterClick }
  ];
